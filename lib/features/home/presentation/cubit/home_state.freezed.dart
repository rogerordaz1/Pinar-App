...
extension HomeStatePatterns on HomeState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(
            ...
            List<NegocioPreview> negocios,
            List<ProductoPopular> productos)?
        loaded,
    ...
    switch (_that) {
      ...
      case HomeLoading() when loading != null:
        return loading();
      case HomeLoaded() when loaded != null:
        return loaded(_that.categorias, _that.promociones, _that.negocios,
            _that.productos);
      case HomeError() when error != null:
...
class HomeLoaded implements HomeState {
  const HomeLoaded(
      {required final List<CategoriaNegocio> categorias,
      required final List<Promocion> promociones,
      required final List<NegocioPreview> negocios,
      required final List<ProductoPopular> productos})
      : _categorias = categorias,
        _promociones = promociones,
        _negocios = negocios,
        _productos = productos;

  final List<CategoriaNegocio> _categorias;
  List<CategoriaNegocio> get categorias {
  ...
  List<Promocion> get promociones {
    if (_promociones is EqualUnmodifiableListView) return _promociones;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_promociones);
  }

  final List<NegocioPreview> _negocios;
  List<NegocioPreview> get negocios {
    if (_negocios is EqualUnmodifiableListView) return _negocios;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_negocios);
  }

  final List<ProductoPopular> _productos;
  List<ProductoPopular> get productos {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._promociones, _promociones) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_promociones),
      const DeepCollectionEquality().hash(_negocios),
      const DeepCollectionEquality().hash(_productos));

  @override
  String toString() {
    return 'HomeState.loaded(categorias: $categorias, promociones: $promociones, negocios: $negocios, productos: $productos)';
  }
}
    ...
    return _then(HomeLoaded(
      categorias: null == categorias
          ...
          : categorias // ignore: cast_nullable_to_non_nullable
              as List<CategoriaNegocio>,
      promociones: null == promociones
          ? _self._promociones
          : promociones // ignore: cast_nullable_to_non_nullable
              as List<Promocion>,
      negocios: null == negocios
          ? _self._negocios
          : negocios // ignore: cast_nullable_to_non_nullable
              as List<NegocioPreview>,
      productos: null == productos
          ? _self._productos
          : productos // ignore: cast_nullable_to_non_nullable
              as List<ProductoPopular>,
    ));
  }
}
